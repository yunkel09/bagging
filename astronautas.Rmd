...
In this example analysis, let's fit a model to predict [the sex of astronauts](https://allisonhorst.github.io/palmerastronauts/) from species and measurement information.
...
```{r}
set.seed(123)
penguin_split <- initial_split(astronauts, strata = sex)
